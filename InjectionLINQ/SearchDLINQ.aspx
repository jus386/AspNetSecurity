<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SearchDLINQ.aspx.cs" Inherits="InjectionLINQ.SearchDLINQ" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <hgroup class="title">
        <h1>Search.</h1>
        <h2>Uses LINQ2SQL with Dynamic LINQ extension. Vulnerable to Injection.</h2>
    </hgroup>
    <fieldset>
