<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SearchVulnerableSP.aspx.cs" Inherits="InjectionSQL.SearchVulnerableSP" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <hgroup class="title">
        <h1>Search.</h1>
        <h2>Uses procedure that constructs queries from strings. Vulnerable to SQL Injection.</h2>
    </hgroup>
    <fieldset>
